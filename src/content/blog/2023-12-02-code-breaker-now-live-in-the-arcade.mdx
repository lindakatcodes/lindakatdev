...
Finding myself currently in the market for a new job, I knew I wanted more projects to share on my portfolio. But none of the other ideas I've got for sites felt all that interesting. So I decided I want to use the Arcade to be a way to showcase skills and personality in one, and will be a lot more fun to talk about with other people too!

## Progress thoughts

So I'm working towards getting it ready, and getting Code Breaker live on it is the next big step. Porting the code itself over into an Astro component was fairly straight forward, but it's honestly not ideal the way it is. 
