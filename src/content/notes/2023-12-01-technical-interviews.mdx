...
lastUpdate: 2021-04-12T00:00:00.000Z
type: notes
source: Emma Bostian
tags:
  - Career
...
**If you're happy with the offer** you don't _have_ to negotiate, but typically a company doesn't make their best offer first. There's no shame in trying. But sometimes they do, and if you're happy with the offer you still win!
...
Stacks allow for constant time O(1) for adding and removing of the <strong>top</strong> item. Very performant, since we don't need to shift any items around to get the top item.
