---
  ...
  blurb: "A virtual arcade! View all the games available or select one to play (instructions are included). I built this in Astro so I could write each game in a different JavaScript framework and keep growing my knowledge!"
