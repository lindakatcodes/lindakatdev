---
  ...
  description: "A virtual arcade! View all the games available or select one to play (instructions are included). I built this in Astro so I could write each game in a different JavaScript framework and keep growing my knowledge!"
...
---
  ...
  "purpose": "One of my all-time favorite pastimes is playing games. I was starting to collect a few different ones I’ve made during my learning journey, and decided it was time to give them their own home! Now I have a space to show off the games I’ve built and can easily add new games and continue to explore.",
  "highlights": [
  ...
  "detailImage1": "../../assets/projects/arcade-detail-1.png",
