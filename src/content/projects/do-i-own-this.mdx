---
  ...
  description: "A nail polish inventory tracking site. Add and view your collection, make changes, search, and filter based on color or brand. This is the project I used to teach myself my first framework, Vue!"
...
---  
  ...
  "detailImage1": "../../assets/projects/diot-detail-1.png",
  "detailImage1Alt": "At the top left, a link in black text with a pink underline saying Back to All Items. In the center of the page, a hand holds a bottle of blue nail polish that says Zoya. Underneath the photo, there is data about the polish - the name Sia, brand Zoya, color group blue, and finish gloss.",
  "detailImage2": "../../assets/projects/diot-detail-2.png",
  "detailImage2Alt": "A heading bar with Do I Own This on the left, and a greeting and sign out button on the right. Then, a filter bar, showing a drop down menu and a text box with a search button. Underneath, there is welcome text, introducing the site and instructing the user to sign in to start their collection.",
