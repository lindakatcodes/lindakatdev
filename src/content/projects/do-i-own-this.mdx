---
  ...
  blurb: "This is the first project I built on my own. I have a ton of nail polish and got the idea to build a site that allows me to track the ones I have, so I don't buy duplicates at the store. It was a great way to learn Vue and build some chops around managing state for a site."
